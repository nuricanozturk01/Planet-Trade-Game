...
public final class BuyFuel implements IAction
{
    ...
    public String toString()
    {
        ...
        if (initialPlayerMoney <= 0)
            sb.append(m_player.getName()).append(" on fuel station but who not have enough money!").append("\n");
        else
        {
            ...
            sb.append(format(START_MESSAGE, m_player.getName(), initialPlayerMoney, m_spaceship.getName(),
                    ...
                    .append("\n");
            sb.append(
                    format(END_MESSAGE, m_player.getName(), m_spaceship.getCurrentFuel(), m_spaceship.getFuelCapacity(),
